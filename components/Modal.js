...
function Modal() {
    ...
    const uploadPost = async() => {
        ...
        // get the download url from the firebase storage and upload to the original post with image
    ...
    <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={setOpen}>
            <div classNAme="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <Transition.Child as={Fragment} enter="ease-out duration-300" enterForm="opacity-0" enterTo="opacity-100" leave="ease-in duration-200" leaveForm="opacity-100" leaveTo="opacity-0">
                            ...
                            <div>
                                <div className="mt-3 text-center sm:mt-5">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        ref={captionRef}
                                        type="text" 
                                        className="border-none focus:ring-0 w-full text-center" placegolder="Please enter a caption.."/>
                                    </div>
                                </div>
                            </div>
